...
class SecureConnection extends Connection {
  ...
  static createSecureContextOptions(options) {
    ...
    const secureContextOptions = {
      key: sslKey ? (0, _fs.readFileSync)(sslKey) : sslKeyContent ? sslKeyContent : undefined,
      cert: sslCert ? (0, _fs.readFileSync)(sslCert) : sslCertContent ? sslCertContent : undefined,
      passphrase: sslPassphrase || undefined,
      rejectUnauthorized: rejectUnauthorized,
      ca: ca ? (0, _fs.readFileSync)(ca) : caContent ? caContent : undefined
    };
